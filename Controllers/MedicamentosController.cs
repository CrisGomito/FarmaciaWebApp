...
public class MedicamentosController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Id,Nombre,Precio,Stock,ProveedorId,Proveedor")] Medicamento medicamento)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? id, [Bind("Id,Nombre,Precio,Stock,ProveedorId,Proveedor")] Medicamento medicamento)
    {
